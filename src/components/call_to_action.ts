export function callToAction(): string {
  return /*html*/`
    <section class="max-w-2xl mx-auto px-6 py-10 pb-20 text-center">
      ...
      <a href="https://www.quae.com/produit/78/9782876143869/a-guide-to-sugarcane-diseases" target="_blank" rel="noopener noreferrer" class="mt-4 inline-block px-6 py-2 bg-gray-800 text-white text-sm rounded-lg hover:bg-gray-700 transition-colors">
